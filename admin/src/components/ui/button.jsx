...
const variants = {
  gradient:
    'rounded-xl bg-gradient-to-r from-[#0a4d5c] via-[#0ab8d4] to-[#5ce9fc] px-4 py-2.5 font-mono text-xs font-bold uppercase tracking-wide text-white shadow-lg shadow-turquoise/25 hover:brightness-110 active:scale-[0.99]',
  outline:
