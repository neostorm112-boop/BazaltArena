...
const variants = {
  gradient:
    'rounded-lg bg-turquoise px-4 py-2.5 font-mono text-xs font-bold uppercase tracking-wide text-white shadow-lg shadow-turquoise/20 hover:brightness-110 active:scale-[0.99]',
  outline:
