    ...
    <section className="flex flex-col gap-6 rounded-xl border border-plantation bg-timber p-6 max-[360px]:gap-4 max-[360px]:p-4">
      ...
      <form className="flex flex-col gap-5 max-[360px]:gap-4" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          disabled={pending}
          className="group flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-turquoise px-4 font-sans text-sm font-semibold leading-5 text-white transition-colors duration-150 hover:bg-[#0ab0d4] disabled:opacity-60"
        >
