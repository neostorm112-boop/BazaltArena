...
└────────┬─────────┘
  ...
  Socket.io ──── DATA_UPDATED ────▶ все подключённые клиенты
            ...
            <Table
              headers={['Ачивка', 'Условие']}
              rows={[
                ['Архитектор', 'Выдаётся создателю платформы'],
                ['Первый', 'Выложил решение первым в спринте'],
                ['Принято', 'Первое решение принято наставником'],
                ['Первый шаг', 'Отправил первое решение в жизни'],
                ['Газующий', 'Не пропустил ни одного спринта'],
                ['Невидимка', 'Ни разу не участвовал'],
                ['Народный любимец', 'Решение собрало 25+ лайков'],
                ['Сотка', 'Получил 100 баллов за решение'],
                ['Чемпион спринта', 'Лучшее решение в спринте'],
              ]}
            />
            <p>
              Логика выдачи живёт в <Code>achievementGranter.ts</Code>. Ачивки не выдаются дважды —
              сервис проверяет существующие <Code>UserAchievement</Code> перед записью.
            </p>
